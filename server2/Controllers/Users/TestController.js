...
const TestController = async (req, res, next) => {
  ...
  // console.log("THIS IS COIN FROM CONTEXT " + req.body.coin)
  // console.log("THIS IS BACKCOIN FROM CONTEXT " + req.body.backCoin)
  ...
  if (req.body.backCoin != 'USDT') {
    console.log("THIS IS NOT USDT " + req.body.backCoin)
      
  } else {
    console.log("THis is usdt " + req.body.backCoin)
    }
